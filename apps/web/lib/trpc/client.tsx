...
/**
 * tRPC client plumbing for the browser — mirrors the reference crm repo.
 *
 * The client talks to the same-origin `/api/trpc` URL, which Next.js rewrites
 * proxy to the NestJS API (see next.config.mjs). Requests carry the session
