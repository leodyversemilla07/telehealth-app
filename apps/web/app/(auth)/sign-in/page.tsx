...
export default function SignInPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // Safely check for twoFactorRedirect
  ...
  async function handleTwoFactorSubmit(e: React.FormEvent) {
    ...
    // Automatically detect code type: 6-digit numeric is TOTP, otherwise treat as backup code
  ...
  // -------------------------------------------------------------
  // VIEW: 2FA Authentication Screen
  // -------------------------------------------------------------
  if (showTwoFactor) {
    return (
      <div className="flex min-h-svh items-center justify-center p-6 bg-gradient-to-tr from-background via-background/90 to-muted/20">
        <div className="w-full max-w-sm space-y-6 bg-card/60 backdrop-blur-md border border-border/40 p-8 rounded-2xl shadow-2xl transition-all duration-300">
          <div className="space-y-2 text-center">
            ...
            <p className="text-muted-foreground text-sm">
              Enter your 6-digit authenticator code or one of your 10-character
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  className="pl-10 font-mono tracking-wider placeholder:font-sans placeholder:tracking-normal py-5 rounded-xl border border-border/60 focus:border-primary/50"
                  required
                  autoFocus
                />
          ...
          <button
            type="button"
            className="flex items-center justify-center gap-1.5 w-full text-xs text-muted-foreground hover:text-foreground transition-colors duration-200 mt-4"
            onClick={() => {
