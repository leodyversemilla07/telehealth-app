        ...
        <div className="grid grid-cols-1 gap-6">
          {appointments.map((appt) => {
            ...
            return (
              <Card
                key={appt.id}
                className="border border-border/40 hover:shadow-md transition-all overflow-hidden relative group"
              >
                {/* Accent status line */}
                <div
                ...
                <CardFooter className="pl-8 bg-muted/15 border-t border-border/20 py-3.5 px-6 flex flex-col sm:flex-row justify-between sm:items-center gap-4">
