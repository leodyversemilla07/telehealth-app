// App factory: assembles the Nest application (middleware, interceptors,
// filters, CORS, uploads gate, socket.io) WITHOUT listening. main.ts only
// boots it and calls listen(), so the whole wiring is exercisable from
// tests without opening a port (mirrors the reference crm create-app.ts).
